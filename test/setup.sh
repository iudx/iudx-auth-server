...
openssl req -new -key restricted.key.pem -out restricted.csr -sha256 -subj '/CN=individual/emailAddress=barun@iisc.ac.in/id-qt-unotice=class:2;can-access:rbccps.org\/.*\/r1\/.*'
